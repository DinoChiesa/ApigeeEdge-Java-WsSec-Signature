...
public abstract class WsSecCalloutBase extends CalloutBase implements Execution {
    ...
    abstract public ExecutionResult execute0(MessageContext msgCtxt) throws Exception;
